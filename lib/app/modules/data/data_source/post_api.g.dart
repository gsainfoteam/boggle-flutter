...
class _PostApi implements PostApi {
  ...
  @override
  Future<PostListModel> getPosts(GetPostsQueryModel query) async {
  ...
  @override
  Future<PostModel> postPosts(CreatePostModel model) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = model;
  ...
  @override
  Future<PostModel> getPost(String uuid) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
