...
// my : 내가 작성한 공지, 내가 참여한 공지 등 개인화 필터링용
  ...
  @override
  String toString() {
    return 'GetPostsQueryModel(offset: $offset, limit: $limit, search: $search, tags: $tags, my: $my, category: $category)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, offset, limit, search,
      const DeepCollectionEquality().hash(_tags), my, category);
...
abstract class _GetPostsQueryModel implements GetPostsQueryModel {
  const factory _GetPostsQueryModel(
      ...
      final List<String>? tags,
      final PostMy? my,
      final PostCategory? category}) = _$GetPostsQueryModelImpl;
  ...
  @override
  PostMy? get my; // my : 내가 작성한 공지, 내가 참여한 공지 등 개인화 필터링용
  @override
