...
class GradePickerDialog extends StatefulWidget {
  ...
  const GradePickerDialog({required this.items, required this.initialItem});

  @override
  State<GradePickerDialog> createState() => GradePickerDialogState();
}

class GradePickerDialogState extends State<GradePickerDialog> {
