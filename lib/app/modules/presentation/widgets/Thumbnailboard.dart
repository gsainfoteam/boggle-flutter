...
/*import 'package:ziggle/app/modules/common/presentation/extensions/confirm.dart'; // 정말로 삭제하시겠습니까? 같은 기능을 해주는 extensions
import 'package:ziggle/app/modules/common/presentation/extensions/toast.dart'; // snackbar 띄워주는 extensions
import 'package:ziggle/app/modules/common/presentation/widgets/ziggle_pressable.dart'; // button 클릭 시 눌려짐 표현 widget. 지금은 구현 x
import 'package:ziggle/app/modules/core/data/models/analytics_event.dart'; // model
import 'package:ziggle/app/modules/core/domain/enums/page_source.dart'; // domain
import 'package:ziggle/app/modules/core/domain/repositories/analytics_repository.dart'; // domain
import 'package:ziggle/app/modules/groups/presentation/widgets/sliver_pinned_box_adapter.dart'; // Silver 라는 걸 통해서 ListView 에서 pinned를 할 수 있따.
import 'package:ziggle/app/modules/notices/domain/entities/notice_content_entity.dart'; // domain
import 'package:ziggle/app/modules/notices/domain/entities/notice_entity.dart'; // domain
import 'package:ziggle/app/modules/notices/domain/enums/notice_reaction.dart'; // domain
import 'package:ziggle/app/modules/notices/presentation/bloc/notice_bloc.dart'; // bloc
import 'package:ziggle/app/modules/notices/presentation/cubit/copy_link_cubit.dart'; // bloc
import 'package:ziggle/app/modules/notices/presentation/cubit/share_cubit.dart'; // bloc 
...
import 'package:ziggle/app/modules/user/presentation/bloc/user_bloc.dart'; // bloc*/
import 'package:auto_route/auto_route.dart';
...
class NoticeRenderer extends StatefulWidget {
  ...
  // final NoticeEntity notice; <- NoticeEntity는 notice_entity.dart에 정의된 domain 계층의 모델 클래스이다.
