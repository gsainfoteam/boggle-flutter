...
class _$UserEntityImpl with DiagnosticableTreeMixin implements _UserEntity {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserEntity(id: $id, name: $name, email: $email, studentId: $studentId, major: $major, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, studentId, major, status);
